    ...
    def add_text_to_regions_with_word_boxes(self):
        ...
        for i, box in enumerate(self.text_area):
            ...
            for word in words:
                ...
                cv2.putText(image_copy, word, (random_x, random_y), font, font_scale, (0, 0, 0), thickness, cv2.LINE_AA)
                cv2.rectangle(image_copy, (random_x, top_left_y), (random_x + word_width, random_y + baseline), (0, 0, 255), 12)
                random_x = random_x + word_width + space
